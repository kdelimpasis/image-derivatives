...
### Example 1
Calculate the kernel $K$ with length $2n+1$ for the order $ord$ derivative

> K=descrete_deriv(ord,n)

Kernel $K$ is calculated as

> 0.0111,  -0.1500,  1.5000,  -2.7222,  1.5000,  -0.1500,  0.0111

### Example 2
Given an image $I$, calculate the $$I_{xy}= \frac{\partial^2 I}{\partial x \partial y} $$ using a kernel with size 9×9 
